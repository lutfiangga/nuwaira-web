...
<div
	class="flex-1 flex flex-col max-w-5xl mx-auto flex items-center justify-center px-4 pb-12 md:pb-24 lg:pb-32"
>
	<div class="w-full flex flex-col items-center text-center gap-6 px-6">
		<Badge variant="glass" class="font-semibold text-sm md:text-base">
		...
		<div class="flex justify-between gap-2 md:gap-4 font-jakarta-plus *:text-base">
			<Button
				href="https://instagram.com/nuwairaacademy"
				target="_blank"
				rel="noopener noreferrer"
				size="lg"
				class="rounded-full bg-white text-black hover:bg-white/80"
			>
				Ikuti Kami
			</Button>
			<Button
				href="https://wa.me/6285235353944?text=Halo%20Nuwaira%2C%20saya%20ingin%20konsultasi%20program."
				target="_blank"
				rel="noopener noreferrer"
				size="lg"
				class="rounded-full bg-black text-white hover:bg-black/80"
			>
				Konsultasi Sekarang
			</Button>
		</div>
