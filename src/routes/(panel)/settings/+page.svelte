<script lang="ts">
	...
	$effect(() => {
		if (!photoFile) {
			photoPreview = data.currentUser?.photo || null;
		}
		if (data?.user?.photo) {
			imgError = false;
		}
...
<div class="mx-auto w-full">
	...
	<Tabs.Root value="profile" class="w-full">
		<Tabs.List class="grid w-full grid-cols-3 rounded-xl bg-muted/50 p-1">
			<Tabs.Trigger value="profile" class="rounded-lg data-[state=active]:bg-background data-[state=active]:text-primary data-[state=active]:font-semibold data-[state=active]:shadow-sm">
				<UserCircle class="mr-2 h-4 w-4" />
				Profile
			</Tabs.Trigger>
			<Tabs.Trigger value="security" class="rounded-lg data-[state=active]:bg-background data-[state=active]:text-primary data-[state=active]:font-semibold data-[state=active]:shadow-sm">
				<Lock class="mr-2 h-4 w-4" />
				Security
			</Tabs.Trigger>
			<Tabs.Trigger value="account" class="rounded-lg data-[state=active]:bg-background data-[state=active]:text-primary data-[state=active]:font-semibold data-[state=active]:shadow-sm">
